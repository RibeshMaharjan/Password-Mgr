...
<body class="min-h-screen bg-gray-100 flex items-center justify-center">
    <div class="w-full max-w-md w-full space-y-8 px-3 py-8 bg-white rounded-xl shadow-lg">
        <div class="card border-0 shadow-none">
            ...
            <form id="loginForm" method="post" action="php/auth.php" class="space-y-4">
                <div>
                ...
                <button type="submit" name="enable_2FA" class="h-9 bg-black rounded-md text-white text-sm px-4 py-2 hover:bg-gray-800 transition-all duration-200 w-full">Verify</button>
            </form>
