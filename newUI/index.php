...
<head>
    ...
    <title>KeyNest - Secure Password Manager</title>
...
<body class="min-h-screen bg-gray-50">
    <!-- Header -->
    <header class="h-16 border-b bg-white shadow-sm sticky top-0 z-10">
    ...
    <section id="features" class="py-20 bg-white">
        <div class="container mx-auto px-4">
            <h2 class="text-3xl font-bold text-center mb-12">Why Choose KeyNest?</h2>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <!-- Feature 1 -->
                <div class="feature-card bg-gray-50 p-6 rounded-lg shadow-sm">
    ...
    <section id="how-it-works" class="py-20 bg-gray-50">
        <div class="container mx-auto px-4">
            <h2 class="text-3xl font-bold text-center mb-12">How KeyNest Works</h2>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
                ...
                <!-- Step 2 -->
                <div class="text-center">
                    <div class="w-16 h-16 bg-black rounded-full flex items-center justify-center mx-auto mb-4 text-white font-bold text-xl">2</div>
                    <h3 class="text-xl font-semibold mb-2">Store Your Passwords</h3>
                    <p class="text-gray-600">Add your existing passwords or generate new secure ones.</p>
                </div>
    ...
    <section id="extension" class="py-20 bg-white">
        <div class="container mx-auto px-4">
            <div class="flex flex-col md:flex-row items-center">
                <div class="md:w-1/2 mb-10 md:mb-0">
                    <h2 class="text-3xl font-bold mb-6">Seamless Browser Integration</h2>
                    <p class="text-lg mb-6 text-gray-600">The KeyNest browser extension automatically fills your login information, saving you time and ensuring security.</p>
                    ...
                    <div class="flex space-x-4">
                        <a href="#" class="flex items-center bg-gray-900 text-white px-4 py-2 rounded-md hover:bg-gray-800">
                            <svg class="w-6 h-6 mr-2" fill="currentColor" viewBox="0 0 24 24">
                                <path d="M12 9a3 3 0 1 0 0 6 3 3 0 0 0 0-6zm0-4.5c5.52 0 10 4.48 10 10s-4.48 10-10 10S2 20.02 2 14.5 6.48 4.5 12 4.5zm0-2.5C5.92 2 1 6.92 1 13c0 6.08 4.92 11 11 11s11-4.92 11-11c0-6.08-4.92-11-11-11z"/>
                            </svg>
                            Chrome Extension
                        </a>
    ...
    <footer class="bg-gray-900 text-white py-12">
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div>
                    <h3 class="text-xl font-bold mb-4">KeyNest</h3>
                    <p class="text-gray-400 mb-4">Your secure password manager for all devices.</p>
                    <div class="flex space-x-4">
